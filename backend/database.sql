CREATE DATABASE IF NOT EXISTS asso_avenir;
USE asso_avenir;
...
('involve_joinform_label_contribution_title', 'Formulaire adhésion : détail', 0),
('involve_joinform_label_contribution_adherent', 'Formulaire adhésion : adhérent', 0),
('involve_joinform_label_contribution_adherentjeune', 'Formulaire adhésion : adhérent jeune', 0),
('involve_joinform_label_contribution_adherentbienfaiteur', 'Formulaire adhésion : adhérent bienfaiteur', 0),
