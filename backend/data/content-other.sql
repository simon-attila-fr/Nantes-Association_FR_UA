...
-- ("Mentions Légales", "FR", 40),
-- ("Юридична інформація", "UK", 40),
-- ("L’adresse du site est : https://www. - Contact : Marianne - Nantes - assoavenirukrfr@gmail.com - Hébergeur : WCS", "FR", 41),
-- ("Адреса сайту: https://www. - Контактна особа : Маріанна – Нант – assoavenirukrfr@gmail.com Хост: WCS", "UK", 41),
...
-- ("Accueil", "FR", 47),
-- ("Ласкаво просимо", "UK", 47),
("Faire un don", "FR", 49),
("Зробіть пожертву", "UK", 49);