...
export default function NewsContent() {
  return (
    // <>
    //   <div className="news-bloc">
    //     <div className="news-card">
    //       <h3 className="news-card-title">
    //         Notre dernière actu en date du 03/06/2022
    //       </h3>
    //       <div className="news-card-content">
    //         <img className="news-card-illustration" src={news1} alt="" />
    ...
    //     <div className="news-card">
    //       <h3 className="news-card-title">
    //         Notre dernière actu en date du 04/06/2022
    //       </h3>
    //       <div className="news-card-content">
    //         <img className="news-card-illustration" src={news2} alt="" />
    //         <p className="news-card-text">
    ...
    //     <div className="news-card">
    //       <h3 className="news-card-title">
    //         Notre dernière actu en date du 05/06/2022
    //       </h3>
    //       <div className="news-card-content">
    //         <img className="news-card-illustration" src={news3} alt="" />
    //         <p className="news-card-text">
    //           Le 5 juin Une partie de l'équipe de l'association Avenir
    //           Franco-Ukrainien. Fin du chargement, le camion est prêt à partir.
    //           Destination la ville de KhmelnytskyÏ.
    //         </p>
    //       </div>
    //     </div>
    //   </div>
    ...
    //     <div className="news-card">
    //       <h3 className="news-card-title">
    //         Notre dernière actu en date du 06/06/2022
    //       </h3>
    //       <div className="news-card-content">
    //         <img className="news-card-illustration" src={news4} alt="" />
    //         <p className="news-card-text">
