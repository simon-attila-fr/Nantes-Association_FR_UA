        ...
        <div className="donate-block">
          ...
          <div className="donate-bonus">
            <p className="donate-bonus-text">
              ...
              de 75% de son montant dans la limite de 1000 euros de dons
              (plafond 2020). Au-delà, la réduction d’impôt est de 66 % du
              montant dans la limite de 20 % de vos revenus nets imposables.
              Vous pouvez par la suite remplir vos coordonnées personnelles,
              elles sont indispensables pour que nous puissions traiter votre
              don et vous envoyer un reçu fiscal.
            </p>
          </div>
        ...
        <div className="join-block">
          ...
          <div className="join-bonus">
            <p className="join-bonus-text">
              Bon à savoir : Le montant de votre cotisation sera fonction de
              votre statut de membre : adhérents (15€), adhérents jeunes (8€),
              ou encore adhérents bienfaiteurs, associations, collectivités
          ...
          <div className="join-form">
            <p className="join-form-text">
              ...
              vers vous dès que votre adhésion sera enregistrée pour le
              réglement de votre cotisation et l'envoi de votre reçu fiscal.
            </p>
          </div>
